...
# Azure Storage設定
AZURE_STORAGE__ACCOUNT_NAME: str = str(config("AZURE_STORAGE__ACCOUNT_NAME", default="brownieatelierdata"))
AZURE_STORAGE__ACCOUNT_KEY: str = str(config("AZURE_STORAGE__ACCOUNT_KEY", default=""))
AZURE_STORAGE__CONNECTION_STRING: str = str(config("AZURE_STORAGE__CONNECTION_STRING", default=""))
...
AZURE_STORAGE__BLOB_CONTAINER_NAME: str = str(config("AZURE_STORAGE__BLOB_CONTAINER_NAME", default="brownie-atelier"))
